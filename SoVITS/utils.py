...
def get_f0_predictor(f0_predictor, hop_length, sampling_rate, **kargs):
    if f0_predictor == "pm":
        ...
        from SoVITS.modules.F0Predictor.CrepeF0Predictor import CrepeF0Predictor
        ...
        from SoVITS.modules.F0Predictor.HarvestF0Predictor import HarvestF0Predictor

        f0_predictor_object = HarvestF0Predictor(
            hop_length=hop_length, sampling_rate=sampling_rate
        )
    elif f0_predictor == "dio":
        from SoVITS.modules.F0Predictor.DioF0Predictor import DioF0Predictor

        f0_predictor_object = DioF0Predictor(
            hop_length=hop_length, sampling_rate=sampling_rate
        )
    elif f0_predictor == "rmvpe":
        from SoVITS.modules.F0Predictor.RMVPEF0Predictor import RMVPEF0Predictor
        ...
        from SoVITS.modules.F0Predictor.FCPEF0Predictor import FCPEF0Predictor
